...
<?php else: ?>
	...
	<?php if($user['unitnature'] == 4): ?><dl>
            ...
            <div class="shopBox">
                ...
                <div class="clear"></div>
			<form action="<?php echo U('News/edit');?>" method="POST" id="formid">
                <table  border="0" cellspacing="0" class="texttb">
				  <?php if($article['status'] == '2'): ?><tr>
						 <td width="136" class="text-nav">未通过审核原因 :</td>
						<td><input type="text" name="SUGGESTION" id="SUGGESTION" class="text1" size="60" value="<?php echo ($article["suggestion"]); ?>"></td>
				    </tr><?php endif; ?>
                  <tr>
                    <td  class="text-nav">新闻标题：</td>
                    <td><input class="text1 validate[required]" name="TITLE" id="TITLE" value="<?php echo ($article['title']); ?>"/></td>
                  </tr>
                 
                 
                  <tr>
                    <td class="text-nav">新闻内容：</td>
                    <td><textarea  class="editshow" style="height:320px;" id="INFO" name="INFO"><?php echo ($article['info']); ?></textarea></td>
                  </tr>
				  <tr>
                    <td  class="text-nav">作者：</td>
                    <td><input class="text1 txt1 validate[required]" name="AUTHOR" id="AUTHOR" value="<?php if($article['author'] == ''): echo ($user['companyname']); else: echo ($article['author']); endif; ?>"></td>
                  </tr>
				  <tr>
                    <td  class="text-nav">来源：</td>
                    <td><input class="text1 txt1 validate[required]"  name="SOURCE" id="SOURCE" value="<?php if($article['source'] == ''): ?>科济天下<?php else: echo ($article['source']); endif; ?>"/></td>
                  </tr>
				  <tr>
                    <td  class="text-nav">关键词：</td>
                    <td>
						<input class="text1 txt1 validate[required,custom[onlyChina]]" maxLength="10" name="KEYWORD1" id="KEYWORD1" value="<?php echo ($key[0]); ?>"/>
						<input class="text1 txt1 validate[custom[onlyChina]]" maxLength="10" name="KEYWORD2" id="KEYWORD2" value="<?php echo ($key[1]); ?>"/>
						<input class="text1 txt1 validate[custom[onlyChina]]" maxLength="10" name="KEYWORD3" id="KEYWORD3" value="<?php echo ($key[2]); ?>"/>
				  ...
				  <tr>
                    ...
                    <td>
						<input class="text1 sort"  name="ORD" id="ORD" value="<?php echo ($article['ord']); ?>"/>						
					</td>
                  </tr>
				   ...
				   <tr>
                    ...
                    <td>
						 <input type="radio" style="margin-left:15px;" name="IS_CHXIN" id="IS_CHXIN" class="radio_style" value="1" <?php if($article['is_chxin'] == '1'): ?>checked="checked"<?php endif; ?> > &nbsp;是&nbsp;&nbsp;&nbsp;
        	             <input type="radio" name="IS_CHXIN" id="IS_CHXIN" class="radio_style" value="0" <?php if($article['is_chxin'] == '0' OR $article['is_chxin'] == ''): ?>checked="checked"<?php endif; ?>> &nbsp;否
                    ...
                    <td>
						 <select name="CHXINID">
							<?php if(is_array($xkind)): $i = 0; $__LIST__ = $xkind;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$val): $mod = ($i % 2 );++$i;?><option value="<?php echo ($val['id']); ?>" <?php if($article['chxinid'] == $val['id']): ?>selected="selected"<?php endif; ?>><?php echo ($val['syname']); ?></option><?php endforeach; endif; else: echo "" ;endif; ?>
						 </select>
					</td>
					</tr>
					<tr>
                    ...
                    <td>
						<input type="radio" style="margin-left:15px;" name="IS_SHOW" id="IS_SHOW" class="radio_style" value="1" <?php if($article['IS_SHOW'] == '1' OR $article['IS_SHOW'] == ''): ?>checked="checked"<?php endif; ?> > &nbsp;是&nbsp;&nbsp;&nbsp;
        	             <input type="radio" name="IS_SHOW" id="IS_SHOW" class="radio_style" value="0" <?php if($article['IS_SHOW'] == '0'): ?>checked="checked"<?php endif; ?>> &nbsp;否
					</td>
                  </tr>
                  <tr>
				  
                    <td class="text-nav"><input type="hidden" name="ID" value="<?php echo ($article['id']); ?>"></td>
                    <td>
                    	<div class="butBox">
