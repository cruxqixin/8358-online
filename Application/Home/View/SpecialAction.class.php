...
class SpecialAction extends BaseAction{
	...
	public function detailes(){
	 /* if($_GET['pro']!='')
		...
		if($resSpecial['TECHKINDS']!=''&&$resSpecial['TECHKINDS']!=null)
		{
		   header('location:' . U( 'home/Special/detailes?SPID='.$resSpecial['ID'] ) );
		}
		if($resSpecial['EXPERTKINDS']!=''&&$resSpecial['EXPERTKINDS']!=null)
		{
		   header('location:' . U( 'home/Special/expert?SPID='.$resSpecial['ID'] ) );
		}
		if($resSpecial['PRODUCTKINDS']!=''&&$resSpecial['PRODUCTKINDS']!=null)
		{
	...
	public function pro()
	{
		...
		if($resSpecial['TECHKINDS']!=''&&$resSpecial['EXPERTKINDS']!=''&&$resSpecial['PRODUCTKINDS']!='')
		{
		 ...
		 else if($resSpecial['TECHKINDS']!=''&&$resSpecial['TECHKINDS']!=null)
		{
		   header('location:' . U( 'home/Special/detailes?SPID='.$resSpecial['ID'] ) );
		}
		else if($resSpecial['EXPERTKINDS']!=''&&$resSpecial['EXPERTKINDS']!=null)
		{
		   header('location:' . U( 'home/Special/expert?SPID='.$resSpecial['ID'] ) );
		}
		else($resSpecial['PRODUCTKINDS']!=''&&$resSpecial['PRODUCTKINDS']!=null)
		{
		   header('location:' . U( 'home/Special/pro?SPID='.$resSpecial['ID'] ) );
		}
		$re=array(
