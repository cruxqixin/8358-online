...
<div class="mainBox">
    ...
    <div class="top-text">
    	<h1>我要申请对接</h1>
        <ul id="news">
        	<a style="color: #fff;" href="<?php echo U('index/apply_c');?>"><li class="current" style="margin-left:0;">专家/观众（个人）对接申请</li></a>
            <a style="color: #fff;" href="<?php echo U('index/apply_b');?>"><li>企业对接申请</li></a>
        </ul>
    </div>
    <div class="application">
    	<div class="fixnone" style="display:block;">
    	<h1>在线对接申请表</h1>
        <form action="<?php echo U('index/apply_c');?>" id="form1" method="post" >
            <div class="application-01">
                <div class="application-02">
                    <h2>姓名</h2>
                    <div class="textBox-01">
                        <input class="text1 validate[required]" type='text' name='name' value="<?php echo ($onlineUser['name']); ?>"/>
                    </div>
                    <h2>职位</h2>
                    ...
                    <h2>部门</h2>
                    <div class="textBox-05 textBox-10">
                        <input class="text7 validate[required]" type='text' name='department' value="<?php echo ($onlineUser['department']); ?>"/>
                    </div>
                </div>
                <div class="application-02">
                    <h2>单位中文名称</h2>
                    <div class="textBox-03">
                        <input class="validate[required]" type='text' name='company_cname' value="<?php echo ($onlineUser['company_cname']); ?>"/>
                    </div>
                    <h2>电话</h2>
                ...
                <div class="application-02">
                    <h2>单位英文名称</h2>
                    <div class="textBox-03">
                        <input class="validate[required]" type='text' name='company_ename' value="<?php echo ($onlineUser['company_ename']); ?>"/>
                    </div>
                    <h2>手机</h2>
                    <div class="textBox-04">
                ...
                <div class="application-02">
                    ...
                    <div class="textBox-07">
                        <input class="validate[required]" type='text' name='address' value="<?php echo ($onlineUser['address']); ?>"/>
                    </div>
                </div>
                <div class="application-10">
                	<h3>所属行业</h3>
                    <ul>
                    	<li><input name="industry" type="radio" value="光学/光电子" checked='checked'/>光学/光电子</li>
                        <li><input name="industry" type="radio" value="航天/航空" />航天/航空</li>
                        <li><input name="industry" type="radio" value="电气工程/电子/半导体" />电气工程/电子/半导体</li>
                        <li><input name="industry" type="radio" value="装备制造" />装备制造</li>
                        <li><input name="industry" type="radio" value="半导体制造业" />半导体制造业</li>
                        <li><input name="industry" type="radio" value="汽车工程" />汽车工程</li>
                        <li><input name="industry" type="radio" value="通信/数据处理" />通信/数据处理</li>
                        <li><input name="industry" type="radio" value="精密工程" />精密工程</li>
                        <li><input name="industry" type="radio" value="医疗/生物技术" />医疗/生物技术</li>
                        <li><input name="industry" type="radio" value="环境监测" />环境监测</li>
                        <li><input name="industry" type="radio" value="安全防范工程" />安全防范工程</li>
                        <li><input name="industry" type="radio" value="化工/制药行业" />化工/制药行业</li>
                        <li><input name="industry" type="radio" value="光伏行业" />光伏行业</li>
                        <li><input name="industry" type="radio" value="商贸" />商贸</li>
                        <li><input name="industry" type="radio" value="非大学研究机构" />非大学研究机构</li>
                        <li><input name="industry" type="radio" value="高等院校" />高等院校</li>
                        <li><input name="industry" type="radio" value="行政管理/政府当局" />行政管理/政府当局</li>
                        <li><input name="industry" type="radio" value="其他" />其他</li>
                    </ul>
                </div>
