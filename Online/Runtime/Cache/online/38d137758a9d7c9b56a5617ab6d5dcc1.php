...
<title>科济天下网_在线对接会_用户详情_<?php echo ($onlineUser['company_name']); ?></title>
...
<div class="mainBox">
    <div class="main-left">
    	<h5>当前位置： <a href="<?php echo U('index/index');?>">首页</a> ><span> 企业用户详情</span></h5>
            ...
            <div class="company-02">
            	<table width="746" border="0" cellspacing="0">
                	<tbody>
                        ...
                        <tr>
                        	<td width="262" colspan="2">公司名称：<a ><?php echo ($onlineUser['company_name']); ?></a></td>
 ...
 foreach($choosenFatherList as $father){ ?>
                ...
                <div class="company-08">
                    ...
                    <div class="company-07">
                        <form action="<?php echo U('index/setSchedule');?>" id="form1" method="post" >
	                    <?php
